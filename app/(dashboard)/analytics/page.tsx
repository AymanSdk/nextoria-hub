...
// Mock data - will integrate with real data later
const revenueData = [
...
export default async function AnalyticsPage() {
  ...
  const hasAccess = ["ADMIN", "DEVELOPER", "MARKETER"].includes(
    session?.user?.role || ""
  );
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-neutral-500 mt-1'>Across all members</p>
          </CardContent>
        </Card>
      </div>
