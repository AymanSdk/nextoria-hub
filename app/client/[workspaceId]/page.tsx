  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-neutral-900 to-neutral-700 dark:from-neutral-100 dark:to-neutral-300" />
              <div>
      ...
      <div className="container mx-auto px-6 py-8 space-y-8">
        ...
        {/* Deliverables */}
        <div>
          <h3 className="text-lg font-semibold mb-4">Recent Deliverables</h3>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-neutral-500">
                          {deliverable.projectName} • {deliverable.fileSize} •{" "}
                          {deliverable.uploadedAt.toLocaleDateString()}
                        </p>
                      </div>
                    </div>
