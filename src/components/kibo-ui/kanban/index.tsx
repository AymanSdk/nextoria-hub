...
export const KanbanBoard = ({
  ...
  return (
    <div
      className={cn(
        "flex size-full min-h-40 flex-col transition-all duration-200",
        isOver &&
          (highlightClassName || "ring-2 ring-primary shadow-lg shadow-primary/30"),
        className
      )}
      ref={setNodeRef}
    >
  ...
  return (
    <ScrollArea className='overflow-hidden'>
      <SortableContext items={items}>
        <div className={cn("flex grow flex-col gap-2", className)} {...props}>
